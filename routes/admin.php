...
Route::get('whatsapp/webhook/{token_url}', [WhatsAppController::class, 'verifyToken'])->name('whatsapp.verify.token');
Route::post('whatsapp/webhook/{token}', [WhatsAppController::class, 'receiveResponse'])->name('whatsapp.webhook');
...
Route::group(['prefix' => localeRoutePrefix()], function () {
    ...
    // Route::post('language/store',[LanguageController::class, 'store'])->name('languages.store');
    // Route::delete('language/destroy/{id}', [LanguageController::class, 'destroy'])->name('languages.destroy');
    // Route::post('languages/update/{id}', [LanguageController::class, 'update'])->name('languages.update');
    // Route::get('language/translations', [LanguageController::class, 'translationPage'])->name('language.translations.page');

...
// import QuickReply from "../../assets/svg/QuickReply.svg";
...
/*  {
 ...
 /* {
    type: 'redirector',
    title: 'Vue Flow',
    subtitle: 'Redirector Edge',
    logoColor: '#7e8c9e',
    logoComponent: Arrow90Down,
  },*/
  {
    type: 'node-image',
    title: 'Image',
...
<template>
  <aside>
    <h1 class="mt-2">Available Components</h1>
    <div class="container">
      <SidebarTemplate v-for="template in templates" v-bind="template" />
    </div>
  </aside>
</template>

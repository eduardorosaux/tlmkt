            ...
            <div class="row">
                ...
                <div class="col-xxl-9 col-lg-8 col-md-8">
                    ...
                    <div class="default-tab-list default-tab-list-v2  bg-white redious-border p-20 p-sm-30">
                        <div class="row">
                            <form action="{{ route('feature.update', $feature->id) }}" method="POST" class="form" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row gx-20 add-coupon">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control rounded-2 ai_content_name" id="icon" name="icon" value="{{ @$feature->icon }}">
                                            <div class="nk-block-des text-danger">
                                    ...
                                    <div class="col-lg-12 input_file_div mb-4">
                                        ...
                                        <div class="selected-files d-flex flex-wrap gap-20">
                                            <div class="selected-files-item">
                                                <img class="selected-img" src="{{ getFileLink('80x80', $feature->image) }}"
                                                     alt="favicon">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            ...
                                            <select  class="form-select form-select-lg mb-3 with_search" name="type" required>
                                                <option value="none" {{ $feature->type == "none" ? 'selected' : '' }}>{{__('none') }}</option>
                                                <option value="whatsapp" {{ $feature->type == "whatsapp" ? 'selected' : '' }}>{{__('whatsapp') }}</option>
                                                <option value="telegram" {{ $feature->type == "telegram" ? 'selected' : '' }}>{{__('telegram') }}</option>

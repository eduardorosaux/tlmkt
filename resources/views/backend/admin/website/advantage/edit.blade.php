...
@section('title', __('edit_advantage'))
@section('content')
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xxl-9 col-lg-8 col-md-8">
                    <h3 class="section-title">{{ __('edit_advantage') }}</h3>
                    <div class="default-tab-list default-tab-list-v2  bg-white redious-border p-20 p-sm-30">
                        <div class="row">
                            <form action="{{ route('advantage.update', $advantage->id) }}" method="POST" class="form" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row gx-20 add-coupon">
                                    ...
                                    <input type="hidden"
                                       value="{{ @$advantage_language->translation_null == 'not-found' ? '' : @$advantage_language->id }}"
                                       name="translate_id">
                                    <input type="hidden" class="is_modal" value="0"/>
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            <label for="title" class="form-label">{{ __('title') }}</label>
                                            <input type="text" class="form-control rounded-2 ai_content_name" id="title" name="title" value="{{ @$advantage_language->title }}">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            ...
                                            <textarea class="form-control" id="description"
                                                      name="description">{{ @$advantage_language->description }}</textarea>
                                            <div class="nk-block-des text-danger">
                                    ...
                                    <div class="col-lg-12 input_file_div mb-4">
                                        ...
                                        <div class="selected-files d-flex flex-wrap gap-20">
                                            <div class="selected-files-item">
                                                <img class="selected-img" src="{{ getFileLink('80x80', $advantage->image) }}"
                                                     alt="favicon">
                                            </div>
                                        </div>
                                    </div>

        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xxl-9 col-lg-8 col-md-8">
                    <h3 class="section-title">{{ __('edit_story') }}</h3>
                    <div class="default-tab-list default-tab-list-v2  bg-white redious-border p-20 p-sm-30">
                        <div class="row">
                            <form action="{{ route('story.update', $story->id) }}" class="form-validate form"
                                    method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    ...
                                    <input type="hidden"
                                       value="{{ @$story_language->translation_null == 'not-found' ? '' : @$story_language->id }}"
                                       name="translate_id">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            ...
                                            <textarea class="form-control" id="description"
                                                      name="description">{{ @$story->language->description}}</textarea>
                                    ...
                                    <div class="col-lg-12 input_file_div">
                                        ...
                                        <div class="selected-files d-flex flex-wrap gap-20">
                                            <div class="selected-files-item">
                                                <img class="selected-img" src="{{ getFileLink('80x80', $story->image) }}"
                                                     alt="favicon">
                                            </div>
                                        </div>
                                    </div>

                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-unstyled">
                                            ...
                                            <li>3. {{__('whatsApp_cloud_api_line_three')}} {{ __('callback_url') }} and {{ __('verify_token') }}.</li>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-unstyled">
                                            <li>1. {{__('follow_the_detailed_process_outlined_in_the_facebook_docs_to_create_a_permanent_access_token')}} <a
                                            ...
                                            <li>2. {{__('once_you_have_obtained_the_permanent_access_token_enter_it_here')}}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>

						...
						<div class="row row-eq-height mb-3">
							<div class="col-lg-6">
								<div class="card h-100 ">
									...
									<div class="card-body">
										<div class="mb-4">
											<label for="access_token" class="form-label">{{ __('bot_token') }} <span class="text-danger">*</span></label>
											<div class="input-group">
												<input type="text"
												       ...
												       placeholder="{{ __('bot_token') }}"
												       aria-label="{{ __('enter_bot_token') }}"
												       aria-describedby="bot_token"
												       @if (!empty(@Auth::user()->client->telegramSetting->access_token)) disabled @endif required>

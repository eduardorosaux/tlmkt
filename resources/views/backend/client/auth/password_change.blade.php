                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="admin-profile">
                                    <img src="{{ getFileLink('300x300',auth()->user()->images) }}" alt="User Profile img">
                                </div>
                            </div>
                        </div>
                        <form method="POST" action="{{ route('client.profile.password-update') }}" enctype="multipart/form-data" class="form">
                            @csrf

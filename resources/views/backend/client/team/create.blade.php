			...
			<div class="col-lg-12">
				...
				<div class="default-tab-list table-responsive default-tab-list-v2 activeItem-bd-md bg-white redious-border p-20 p-sm-30">
					<div class="default-list-table yajra-dataTable">
						<form class="form" action="{{ route('client.team.store') }}"
									...
									<div class="row gx-20">
											...
											<div class="col-xl-3 col-lg-4 col-md-6">
												<div class="price-checkbox d-flex gap-12 mb-4">
													...
													<div class="setting-check">
														<input name="permissions[{{ $key }}]" type="checkbox" id="{{ $key }}" checked value="1">
														<label for="{{ $key }}"></label>
													</div>
												</div>
											</div>
										...
										<div class="col-lg-3">
											<div class="price-checkbox d-flex gap-12 mb-4">
												...
												<div class="setting-check">
													<input name="permissions[manage_chat]" type="checkbox" id="checkbox9" checked value="1">
											...
											<div class="price-checkbox d-flex gap-12 mb-4">
												...
												<div class="setting-check">
													<input name="permissions[manage_setting]" type="checkbox" id="checkbox10" checked value="1">

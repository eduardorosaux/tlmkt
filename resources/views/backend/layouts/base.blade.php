...
<body class="{{ request()->routeIs('client.chat.index') || request()->routeIs('client.flow.index') ? 'chat_sidebar_collapse ' : '' }}">
...
<!--====== datatable ======-->
<!--====== MainJS ======-->
<script src="{{ static_asset('admin/js/app.js?ver=1.0.0') }}"></script>

		...
		<nav class="side-nav">
			<ul id="accordionSidebar">
				...
				@can('subscribers.index')
					{{-- <li class="{{ menuActivation(['admin/subscribers'], 'active') }}">
						<a href="#subscribers" class="dropdown-icon" data-bs-toggle="collapse" role="button"
						aria-expanded="{{ menuActivation(['admin/subscribers'], 'true', 'false') }}"
						aria-controls="subscribers">
							<i class="las la-th"></i>
							<span>{{ __('marketing') }}</span>
						</a>
						<ul class="sub-menu collapse {{ menuActivation(['admin/subscribers'], 'show') }}"
							id="subscribers">

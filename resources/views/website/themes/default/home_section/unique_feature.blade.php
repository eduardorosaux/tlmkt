...
@if (!empty($unique_features) && count($unique_features) > 0)
        ...
        <div class="row row--40 mt_dec--30 split-accordion-wrapper">
                            ...
                            <div class="accordion-item card">
                                <h2 class="accordion-header card-header" id="heading{{ $key }}" style="font-family: Inter, Bangla883, sans-serif;">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{ $key }}" aria-expanded="true" aria-controls="collapse{{ $key }}">
                                        <img src="{{ getFileLink('80x80',  $unique_feature->icon) }}" alt="{{ @$unique_feature->language->title }}" style="height: 24px; width:24px;">
            ...
            <div class="col-lg-7 col-md-12 col-sm-12 col-12 mt--30 sal-animate" data-sal="slide-up" data-sal-duration="700" data-sal-delay="200">
                <div class="split-image">
                    <img src="{{ getFileLink('714x300',setting('unique_feature_image')) }}" alt="{!! setting('unique_feature_section_title',app()->getLocale()) !!}">
                </div>
            </div>
        </div>
    </div>

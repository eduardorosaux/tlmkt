            ...
            <div class="row row--15 mt_dec--30 align-items-center">
                <div class="col-lg-6 mt--30">
                    <div class="content">
                        ...
                        <a class="btn-default round has-right-icon btn-large color-green" href="{{ setting('ai_main_action_btn_url') }}">
                            {{ setting('ai_main_action_btn_label', $lang) }} <i class="las la-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>

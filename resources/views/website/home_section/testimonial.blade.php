            ...
            <div class="col-xl-3 col-lg-4 mt--30">
                    <div class="testimonial-card-one">
                        <div class="inner">
                            ...
                            <h6 class="title">{{ @$testimonial->language->title, app()->getLocale() }}</h6>
                            <p class="desc">{!! @$testimonial->language->description, app()->getLocale() !!}</p>
                            <div class="meta-section">
                                <div class="image">
                                    <img src="{{ getFileLink('80x80',  $testimonial->image) }}" alt="">
                                </div>
                                <div class="content">
                                    <h6 class="title">{{ @$testimonial->language->name, app()->getLocale() }}</h6>
                                    <p class="desc">{{ @$testimonial->language->designation, app()->getLocale() }}</p>
                                </div>
                            </div>
                        </div>
                    </div>

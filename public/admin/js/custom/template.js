$(document).ready(function () {
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-3">
                            <label for="type_of_action" class="d-block">Type of Action<span class="text-danger">*</span></label>
                            <select name="type_of_action[]" id="type_of_action" class="form-select" required>
                                <option value="COPY_CODE">OTP</option>
                            </select><div class="invalid-feedback text-danger"></div>
  ...
  function handleTemplateCategoryChange() {
    if ($("#authentication").is(":checked")) {
      $("#none, #quick_reply").prop("disabled", true).prop("checked", false);
      $("#cta").prop("disabled", false).prop("checked", true);
      $('#message_body').prop('required', false).prop('disabled', true);

    } else {
      $("#none, #quick_reply").prop("disabled", false);
      $("#cta").prop("disabled", false);
      $('#message_body').prop('required', true).prop('disabled', false);
  ...
  $('input[name="template_category"]').change(handleTemplateCategoryChange);

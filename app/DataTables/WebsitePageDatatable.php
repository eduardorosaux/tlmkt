    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($page) {
                return view('backend.admin.website.page.column.action', compact('page'));
            })->addColumn('status', function ($page) {
                return view('backend.admin.website.page.column.status', compact('page'));
            })->addColumn('title', function ($page) {
                return $page->lang_title;
            })->addColumn('link', function ($page) {
                return view('backend.admin.website.page.column.link', compact('page'));
            })->setRowId('id');
    }

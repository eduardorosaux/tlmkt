    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('phone', function ($query) {
                return view('backend.client.whatsapp.contacts.phone', compact('query'));
            })
            ->addColumn('status', function ($query) {
                return view('backend.client.whatsapp.contacts.status', compact('query'));
            })

            ->addColumn('checkbox', function ($query) {
                return view('backend.client.whatsapp.contacts.checkbox', compact('query'));
            })
            ...
            ->addColumn('action', function ($query) {
                return view('backend.client.whatsapp.contacts.action', compact('query'));
            })
            ->addColumn('name', function ($query) {
                return view('backend.client.whatsapp.contacts.name', compact('query'));
            })->setRowId('id');
    }

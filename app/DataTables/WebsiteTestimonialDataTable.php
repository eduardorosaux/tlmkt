    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($testimonial) {
                return view('backend.admin.website.testimonial.action', compact('testimonial'));
            })->addColumn('status', function ($testimonial) {
                return view('backend.admin.website.testimonial.status', compact('testimonial'));
            })->addColumn('rating', function ($testimonial) {
                return view('backend.admin.website.testimonial.rating', compact('testimonial'));
            })->addColumn('image', function ($testimonial) {
                return view('backend.admin.website.testimonial.image', compact('testimonial'));

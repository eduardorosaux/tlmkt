...
class CountryDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($country) {
                return view('backend.admin.country.action', compact('country'));
            })->addColumn('status', function ($country) {
                return view('backend.admin.country.status', compact('country'));
            })->setRowId('id');
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('iso2')->title(__('iso2')),
            Column::make('phonecode')->title(__('phonecode')),
            Column::make('currency')->title(__('currency')),
            Column::make('currency_symbol')->title(__('currency_symbol')),

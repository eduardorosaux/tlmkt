    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($success_story) {
                return view('backend.admin.website.successStory.action', compact('success_story'));
            })->addColumn('status', function ($success_story) {
                return view('backend.admin.website.successStory.status', compact('success_story'));
            })->addColumn('image', function ($success_story) {
                return view('backend.admin.website.successStory.image', compact('success_story'));

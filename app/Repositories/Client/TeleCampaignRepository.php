...
{
    use ImageTrait, RepoResponse, WhatsAppTrait,CommonTrait;
    ...
    public function store($request)
    {
        ...
        try {
            ...
            $messageRemaining = auth()->user()->activeSubscription->conversation_remaining;
            ...
            DB::rollBack();
            \Log::info('Telegram Campaign', [$e->getMessage()]);
